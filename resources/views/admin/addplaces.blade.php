                            ...
                            <form action="/add/places" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="map" class="form-control" id="formGroupExampleInput2"
                                        placeholder="Map for the Location">
                                </div>
